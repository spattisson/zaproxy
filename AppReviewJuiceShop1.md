...
&lt;item-id&gt;
 ...
 | Unprotected API Access | Resend Request | May resubmit a PUT request changing quantity of a basket item to a negative quantity through JSON property |
...
/coupon | Weak Encryption   | Hard           | Coupons are simple Z85 encoded strings that may be forged with an appropriate library. |
...
&lt;product-id&gt;
 ...
 | Unprotected API Access / Persistent XSS | Medium         | Any user may modify an existing product by submitting JSON data in a PUT request |
